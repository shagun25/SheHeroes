...
class CityData {
  ...
  Map<String, dynamic> toJson() {
    ...
    data['total_incidents'] = totalIncidents;
...
class Incidents {
  ...
  Map<String, dynamic> toJson() {
    ...
    data['incident_offense_code'] = incidentOffenseCode;
    data['incident_offense_description'] = incidentOffenseDescription;
    data['incident_offense_detail_description'] = incidentOffenseDetailDescription;
